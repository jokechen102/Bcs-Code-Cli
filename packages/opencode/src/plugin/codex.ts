...
<html>
  <head>
    <title>BCS Code - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to BCS Code.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>BCS Code - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
