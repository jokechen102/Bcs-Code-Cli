  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all BCS Code sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific BCS Code session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new BCS Code session for interacting with AI assistants and managing conversations.",
