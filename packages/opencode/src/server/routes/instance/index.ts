  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current BCS Code instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the BCS Code instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the BCS Code system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the BCS Code system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the BCS Code system.",
