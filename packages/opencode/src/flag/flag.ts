...
export const Flag = {
  ...
  MIMOCODE_TRACE_ATTACHMENTS: truthy("MIMOCODE_TRACE_ATTACHMENTS"),
  MIMOCODE_TRACE_LLM_STREAM: truthy("MIMOCODE_TRACE_LLM_STREAM"),
  MIMOCODE_MIMO_ONLY,
  ...
  get MIMOCODE_TUI_FPS() {
    return number("MIMOCODE_TUI_FPS")
  },
