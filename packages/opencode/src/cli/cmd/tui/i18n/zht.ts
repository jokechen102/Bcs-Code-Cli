...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "BCS Code 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  ...
  "tui.tips.formatter": "BCS Code 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "BCS Code 使用 LSP 伺服器進行智慧程式碼分析",
  ...
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 BCS Code 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}bcs-code run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}bcs-code --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}bcs-code run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}bcs-code serve{/highlight} 以無介面模式提供 BCS Code API",
  "tui.tips.attach_server": "用 {highlight}bcs-code run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}bcs-code upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}bcs-code auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}bcs-code agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/opencode{/highlight} 觸發 AI 操作",
  "tui.tips.github_install": "執行 {highlight}bcs-code github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.debug_config": "執行 {highlight}bcs-code debug config{/highlight} 排查設定問題",
  ...
  "tui.tips.zen": "搭配 BCS Code 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
