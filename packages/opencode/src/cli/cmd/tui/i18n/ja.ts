...
export const dict = {
  ...
  "tui.tips.mcp_oauth": "BCS Code は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  ...
  "tui.tips.formatter": "BCS Code は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "BCS Code はインテリジェントなコード解析に LSP サーバを使います",
  ...
  "tui.tips.plugin_protect": "プラグインを書いて BCS Code が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}bcs-code run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}bcs-code --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}bcs-code run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}bcs-code serve{/highlight} を実行するとヘッドレスで BCS Code API にアクセスできます",
  "tui.tips.attach_server": "{highlight}bcs-code run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}bcs-code upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}bcs-code auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}bcs-code agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/opencode{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}bcs-code github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.debug_config": "{highlight}bcs-code debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.zen": "BCS Code と組み合わせて {highlight}/connect{/highlight} で厳選されたモデルを使えます",
  ...
  "tui.voice.error.no_auth": "まず BCS アカウントにログインしてください",
  ...
  "tui.dialog.login.mimo_free.success": "BCS Auto の準備完了 — デフォルトモデルを mimo/mimo-auto に設定しました",
  "tui.dialog.login.mimo_free.unavailable": "BCS Auto プロバイダーが読み込まれていません",
  ...
  "cli.providers.mimo_free.verifying": "BCS Auto チャネルを検証中...",
  "cli.providers.mimo_free.ready": "BCS Auto チャネル準備完了",
  "cli.providers.mimo_free.failed": "BCS Auto の自己診断に失敗",
  "cli.providers.mimo_free.default_set": "デフォルトモデルを mimo/mimo-auto に設定（1M コンテキスト、無料）",
  "cli.providers.mimo_free.usage_hint":
    "ログイン不要 — そのまま bcs-code を実行できます。有料/上位モデルを利用する場合は BCS ブラウザログインを選択してください。",
