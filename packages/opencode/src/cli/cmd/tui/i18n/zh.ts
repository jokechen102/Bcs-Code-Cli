...
export const dict = {
  ...
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/bcscode/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "BCS Code 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  ...
  "tui.tips.formatter": "BCS Code 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "BCS Code 使用 LSP 服务器进行智能代码分析",
  ...
  "tui.tips.plugin_protect": "写一个插件阻止 BCS Code 读取敏感文件",
  "tui.tips.run": "用 {highlight}bcs-code run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}bcs-code --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}bcs-code run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}bcs-code serve{/highlight} 以无头模式提供 BCS Code API",
  "tui.tips.attach_server": "用 {highlight}bcs-code run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}bcs-code upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}bcs-code auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}bcs-code agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opencode{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}bcs-code github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.debug_config": "运行 {highlight}bcs-code debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.zen": "搭配 BCS Code 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.voice.error.no_auth": "请先登录 BCS 账号",
  ...
  "tui.dialog.login.mimo_free.success": "BCS Auto 已就绪 - 默认模型设为 mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "BCS Auto 通道未加载",
  ...
  "cli.providers.mimo_free.verifying": "正在验证 BCS Auto 通道...",
  ...
  "tui.dialog.login.flow.title": "BCS 登录",
