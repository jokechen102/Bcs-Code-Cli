export const dict: Record<string, string> = {
  ...
  "tui.tips.mcp_oauth": "BCS Code auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "tui.tips.formatter": "BCS Code auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "BCS Code uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugin_protect": "Create a plugin to prevent BCS Code from reading sensitive files",
  "tui.tips.run": "Use {highlight}bcs-code run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}bcs-code --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}bcs-code run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}bcs-code serve{/highlight} for headless API access to BCS Code",
  "tui.tips.attach_server": "Use {highlight}bcs-code run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}bcs-code upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}bcs-code auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}bcs-code agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}bcs-code github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.debug_config": "Run {highlight}bcs-code debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with BCS Code for curated, tested models",
  ...
  "tui.voice.error.no_auth": "Please log in to BCS first",
  ...
  "tui.dialog.login.mimo_free.success": "BCS Auto is ready — default model set to mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "BCS Auto provider not loaded",
  ...
  "cli.providers.mimo_free.verifying": "Verifying BCS Auto channel...",
  "cli.providers.mimo_free.ready": "BCS Auto channel ready",
  "cli.providers.mimo_free.failed": "BCS Auto verification failed",
  "cli.providers.mimo_free.default_set": "Default model set to mimo/mimo-auto (1M context, free)",
  "cli.providers.mimo_free.usage_hint": "No login required — just run bcs-code. For paid/premium models, choose BCS browser login instead.",
  ...
  "tui.dialog.login.flow.title": "BCS Login",
